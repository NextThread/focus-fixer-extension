...
<template>
  <div class="box between">
    ...
    <div class="contributor-details">
      ...
      <a target="_blank" :href="details.github"><github-icon /></a>
      <!-- <a target="_blank" :href="details.linkedin"><github-icon /></a> -->
      <!-- <a target="_blank" :href="details.instagram"><font-awesome-icon icon="fa-brands fa-instagram" /></a> -->
      <!-- <a v-if="details.dribble" target="_blank" :href="details.dribble"
        ><dribble-icon -->
    <!-- </a> -->
    </div>
  </div>
...
// import DribbleIcon from '../atoms/Icons/Dribble';
